...
public class AllSubCatAdaptor extends RecyclerView.Adapter<AllSubCatAdaptor.ViewHolder> {


    public List<CategoryDetails> mPostItems;
    Context ctx;
    ...
    public AllSubCatAdaptor(List<CategoryDetails> postItems, Context ctx, RecItemClick listener, int selectedPosition) {
...
//        holder.tvName.setText(mPostItems.get(position).getName());
    ...
    CategoryDetails getItem(int position) {
        return mPostItems.get(position);
    }

    public void addItems(List<CategoryDetails> postItems) {
