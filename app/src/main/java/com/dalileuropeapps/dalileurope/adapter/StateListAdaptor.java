...
public class StateListAdaptor extends RecyclerView.Adapter<StateListAdaptor.ViewHolder> {


    public List<State> mPostItems;
    Context ctx;
    ...
    public StateListAdaptor(List<State> postItems, Context ctx, RecItemClick listener, int selectedPosition) {
    ...
    public void addItems(List<State> postItems) {
