...
public class CountryListAdaptor extends RecyclerView.Adapter<CountryListAdaptor.ViewHolder> implements Filterable {


    private String language = "";
    public List<Country> mPostItems;
    Context ctx;
    ...
    public CountryListAdaptor(List<Country> postItems, Context ctx, RecItemClick listener, int selectedPosition) {
    ...
    public void addItems(List<Country> postItems) {
